"""
Duplicate of ``test_direct_sum`` that passes a *tuple* instead of a *list* as
...
from qutip.core.dimensions import Dimensions as _Dimensions, SumSpace
